  ...
  return (
    <div className="flex flex-col pt-20">
      ...
      <section className="relative py-16 md:py-28 dotted-background">
        <div className="max-w-md max-sm:px-4 sm:max-w-xl lg:max-w-3xl xl:max-w-4xl mx-auto text-center">
          <div className="mb-8">
      ...
      <section className="py-16">
        <div className="px-4 md:px-16 2xl:px-28">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 px-8 sm:px-24 md:px-0 lg:px-8">
